These notes are for the EDITORS of SCAtlas
...
Make sure you have an ID range in the [idranges file](SCAtlas-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [SCAtlas-edit.owl](SCAtlas-edit.owl)

** DO NOT EDIT SCAtlas.obo OR SCAtlas.owl in the top level directory **

[../../SCAtlas.owl](../../SCAtlas.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/EBISPOT/SCAtlas) for details.
 ...
 * [SCAtlas-idranges.owl](SCAtlas-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/SCAtlas_terms.txt file
...
Note: the SCAtlas_terms.txt file may include 'starter' classes seeded from
 ...
 * https://github.com/EBISPOT/SCAtlas/releases
 * https://github.com/EBISPOT/SCAtlas/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/EBISPOT/SCAtlas.svg?branch=master)](https://travis-ci.org/EBISPOT/SCAtlas)
