 ...
 * [SCAtlas.yml](SCAtlas.yml)
     * Determines how your purl.obolibrary.org/obo/SCAtlas/ redirects will be handled
     ...
     * Paste in the contents of [SCAtlas.yml](SCAtlas.yml)
 ...
 * [SCAtlas.md](SCAtlas.md)
     ...
     * Paste in the contents of [SCAtlas.md](SCAtlas.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
